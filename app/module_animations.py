...
###SP scene animations
 ["sitting", acf_enforce_all, amf_priority_die|amf_keep,
	[24.0, "sitting", 0, 40, arf_use_stand_progress|arf_cyclic],
 ],
 ["sitting_drinking", acf_enforce_all, amf_priority_die|amf_keep,
	[20.0, "sitting_drinking", 0, 30, arf_use_stand_progress|arf_cyclic],
 ],
 ["sitting_eating", acf_enforce_all, amf_priority_die|amf_keep,
	[2.5, "sitting_eating", 0, 15, arf_use_stand_progress|arf_cyclic],
 ],
###village
 ["sitting_working_1", acf_enforce_all, amf_priority_die|amf_keep,
	[3, "sitting_working_1", 0, 14, arf_use_stand_progress|arf_cyclic],
 ],
 ["sitting_working_2", acf_enforce_all, amf_priority_die|amf_keep,
	[1.2, "sitting_working_2", 0, 12, arf_use_stand_progress|arf_cyclic],
 ],
 ["sitting_working_3", acf_enforce_all, amf_priority_die|amf_keep,
	[1, "sitting_working_3", 0, 4, arf_use_stand_progress|arf_cyclic],
 ],
 ["sitting_fishing", acf_enforce_all, amf_priority_die|amf_keep,
	[2.5, "sitting_fishing", 0, 8, arf_use_stand_progress|arf_cyclic],
 ],
###
 ["sitting_child_1", acf_enforce_all, amf_priority_die|amf_keep,
	[2.0, "sitting_child_1", 0, 8, arf_use_stand_progress|arf_cyclic],
 ],
 ["sitting_sharpening_1", acf_enforce_all, amf_priority_die|amf_keep,
	[1.5, "sitting_sharpening_1", 0, 4, arf_use_stand_progress|arf_cyclic],
 ],
###
 ["sitting_reading", acf_enforce_all, amf_priority_die|amf_keep,
	[14, "sitting_reading", 0, 22, arf_use_stand_progress|arf_cyclic],
 ],
 ["woodcutting_2", acf_enforce_all, amf_priority_die|amf_keep,
	[1, "woodcutting_2", 0, 15, arf_use_stand_progress|arf_cyclic],
 ],
 ["brooming", acf_enforce_all, amf_priority_die|amf_keep,
	[1.6, "brooming", 0, 36, arf_use_stand_progress|arf_cyclic],
 ],
 ["field_working_1", acf_enforce_all, amf_priority_die|amf_keep,
	[1.3, "field_working_1", 1, 7, arf_use_stand_progress|arf_cyclic],
 ],
 ["field_working_2", acf_enforce_all, amf_priority_die|amf_keep,
	[2, "field_working_2", 0, 5, arf_use_stand_progress|arf_cyclic],
 ],
 ["field_working_3", acf_enforce_all, amf_priority_die|amf_keep,
	[2.3, "field_working_3", 0, 5, arf_use_stand_progress|arf_cyclic],
 ],
 ["grinding", acf_enforce_all, amf_priority_die|amf_keep,
	[1.2, "grinding", 0, 4, arf_use_stand_progress|arf_cyclic],
 ],
 ["smithing", acf_enforce_all, amf_priority_die|amf_keep,
